...
const authorData = {
  ...
  '030105': { authors: '吳宸軒、鄭鈞學、盧苡葦', teachers: '陳建淳' },
  '030106': { authors: '梁祐穎', teachers: '李湘慧、褚煜凱' },
  ...
  '030111': { authors: '秋禹岑、周昀橙、楊晰和', teachers: '吳浩誠、黃御庭' },
  ...
  '030301': { authors: '吳丹、洪子涵、陳微安', teachers: '李建勳、沈志強' },
